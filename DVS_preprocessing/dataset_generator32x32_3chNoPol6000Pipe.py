...
def frame_generator(events_list, number_of_events, accumulation_set, numeric_label):
    ...
    # n_channels:
    n_channels = 3              #3 channels of 2000 events
    ...
    # second set of frames, starting from 1000 so that I have frames [1000:7000].. that are made of channels: [1000:3000],[3000:5000][5000:7000]
...
print('###############################################')
print("saving dataset as: dvs_gesture32x32_6ch6000Pipe.pickle ...")
with open("dvs_gesture32x32_6ch6000Pipe.pickle",'wb') as pickle_file:    
