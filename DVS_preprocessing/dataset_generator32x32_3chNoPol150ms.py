...
def frame_generator(events_list, number_of_events, accumulation_set, numeric_label):
    ...
    frame_duration = 150000          #60ms
    channel_duration = 50000
...
print('###############################################')
print("saving dataset as: dvs_gesture32x32_3chNoPol150ms.pickle ...")
with open("dvs_gesture32x32_3chNoPol150ms.pickle",'wb') as pickle_file:    
