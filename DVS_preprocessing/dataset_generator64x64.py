...
def frame_generator(events_list, number_of_events, accumulation_set, numeric_label):
    ...
    for i in range(n_frames):         
        ...
        frame_ON_resize  = np.zeros(shape=(64,64))    
        frame_OFF_resize = np.zeros(shape=(64,64))
        ...
        frame = np.zeros(shape=(64,64,2))   # final 2-channel frame that will contain both the accumulation of off and on events
...
print('###############################################')
print("saving dataset as: dvs_gesture_64x64.pickle ...")
with open("dvs_gesture_64x64.pickle",'wb') as pickle_file:    
