            ...
            for x in range(32):
                for y in range(32):
                    if ch_count == 0:
                        ...
                        frame[x,y,2] = resized_channel_ON[x,y]
                        frame[x,y,3] = resized_channel_OFF[x,y]
                    elif ch_count == 2:
                        frame[x,y,4] = resized_channel_ON[x,y]
                        frame[x,y,5] = resized_channel_OFF[x,y]
...
print('###############################################')
print("saving dataset as: dvs_gesture32x32_6chPol300ms.pickle ...")
with open("dvs_gesture32x32_6chPol300ms.pickle",'wb') as pickle_file:    
