...
print('###############################################')
print("saving dataset as: dvs_gesture32x32temporal_3chNoPol.pickle ...")
with open("dvs_gesture32x32temporal_3chNoPol.pickle",'wb') as pickle_file:    
