...
print('###############################################')
print("saving dataset as: dvs_gesture32x32_1chNoPol100ms.pickle ...")
with open("dvs_gesture32x32_1chNoPol100ms.pickle",'wb') as pickle_file:    
