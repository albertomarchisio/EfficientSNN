...
def frame_generator_even(events_list, number_of_events, accumulation_set, numeric_label):
    ...
    for fr_count in range(n_frames):
        ...
        for ch_count in range(n_channels):     
            ...
            resized_channel  = np.zeros((64,64))      
            ...
            for i in range(0,128,2):
                for j in range(0,128,2):
                    ...
                    resized_channel[p_x,p_y] =  polarity_count/4 
...
print('###############################################')
print("saving dataset as: dvs_gesture64x64_3chNoPol300msPipe2.pickle ...")
with open("dvs_gesture64x64_3chNoPol300msPipe2.pickle",'wb') as pickle_file:    
